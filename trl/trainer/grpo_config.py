...
class GRPOConfig(TrainingArguments):
    ...
    Parameters:
        ...
        num_orders (`int` or `None`, *optional*, defaults to `None`):
            Number of prompt order variants per group for order-fair training. If specified, this will override
            `num_generations`. This parameter is specifically for training order-fair models where each prompt
            group contains multiple variants with different ordering.
    ...
    def __post_init__(self):
        ...
        if self.num_generations < 2:
            ...
            raise ValueError(
                f"GRPO requires at least 2 generations per prompt to calculate the advantages. You provided "
